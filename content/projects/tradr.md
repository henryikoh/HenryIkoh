---
project: Tradr
title: A Mobile App That Connects You to Local Markets
description: Tradr is a mobile platform that connects individuals with shoppers who help them purchase items from local markets without being physically present, ensuring safe delivery to their doorstep.
cover: /tradr.png
...
![Tradr App Overview](https://miro.medium.com/max/1400/1*IdBddGYMCBdzrjjrLCJqgQ.png)
...
**Identified Needs:**
1. Connect with sellers in markets and buy products wholesale with the aim of reselling them
2. Being able to compare prices of items in local markets from the comfort of their home
3. Being able to purchase everyday items from local markets from the comfort of their homes
4. Get their purchased items safely delivered to them
...
1. Do people want to purchase things at major markets because they want to get a better deal?
2. Would people want to have a contact in the market and would love to do transactions with them?
3. How might we help deliver goods people buy from local markets at scale?
...
![Registration and sign in flow](https://miro.medium.com/max/1400/1*cBuuY2jSHloyCu2_t7lXDw.png)
...
![Home page design](https://miro.medium.com/max/1400/1*UFPGmyrhrIxdvvEpekD8jg.png)
...
![Adding items to shopping list](https://miro.medium.com/max/1400/1*2ogtkBApvoGLlkYuUnAxrw.png)

![Connecting to a shopper](https://miro.medium.com/max/1400/1*U669_-uO3-VgWXs0GC0NhQ.png)
...
![Shopping conversation screens](https://miro.medium.com/max/1400/1*n6trHRDZB6cw7T1NblCIpg.png)

![Shopping flow](https://miro.medium.com/max/1400/1*lbFNV2OjhtLvLFi5ygU3PA.png)
...
![Shopping basket, delivery details and checkout summary flow](https://miro.medium.com/max/1400/1*kFkCToWiV0pSoinxQ7vv1A.png)
...
![Order details page](https://miro.medium.com/max/1400/1*s4EtIha-6Tq2CumG4WTXrw.png)
...
![Shopper's going live in a market](https://miro.medium.com/max/1400/1*hhktX2XY6IaA2Qn48yFHHA.png)

![Shopper accepting a shopping request](https://miro.medium.com/max/1400/1*0YmBGi2q8Cx-jBSRsyE2Dw.png)
...
![Start shopping flow](https://miro.medium.com/max/1400/1*MREMNQTKcp_4LVa8qSzJQw.png)
...
![Flow to add the details of an item during shopping conversation](https://miro.medium.com/max/1400/1*HeiqVjJNQdxdOsm7BkfeVA.png)
...
![Shopping list and flow for ending the shopping conversation](https://miro.medium.com/max/1400/1*4j7cZNcNLRzONRy0J18CtQ.png)

## Shopping History

The shopping history for the shopper shows a list of the details of the shopping the shopper has handled over time.

![Shopping history](https://miro.medium.com/max/1400/1*VNGGeTTqBHjNTJm2WpBLXw.png)

## Order Details

Shows the full details of a particular shopping order completed.

![Order details](https://miro.medium.com/max/1400/1*dUvsNI9JqOq-1uVHLTEPgQ.png)
...
![Shopper earnings](https://miro.medium.com/max/1400/1*-vtPJaIC7-pWFk650WVerw.png)
...
1. I would love to experiment with the idea of having design and development happening simultaneously to avoid having to make the designer work twice as much
2. I learned how to work better with a team and how to give proper feedback without being angry or spiteful
3. I learned how to lead a remote team in many different locations around the world and how to coordinate all of them to achieve the goal of launching
